...
namespace CMS.Web.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAllProducts(int pageSize = 10, int pageNumber = 1)
        {
            return Ok(await _iProductService.GetAllProducts(pageSize, pageNumber));
        }
        [HttpGet("/api/product/GetAllTest")]
        ...
        public async Task<IActionResult> UpdateImageProduct(Request_UpdateImageProduct request)
        {
