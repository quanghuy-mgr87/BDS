...
const referAndEarnSteps = [
  {
    icon: 'tabler-send',
    title: 'Gửi lời mời 👍🏻',
    subtitle: 'Gửi liên kết giới thiệu cho bạn của bạn',
  },
  {
    icon: 'tabler-rocket',
    title: 'Đăng ký 😎',
    subtitle: 'Hãy mời họ đăng ký dịch vụ',
  },
  {
    icon: 'tabler-keyboard',
    title: ' Dùng thử 🎉',
    subtitle: 'Bạn của bạn có thể được sử dụng dịch vụ của chúng tôi trong 30 ngày một cách miễn phí',
  },
]
</script>
